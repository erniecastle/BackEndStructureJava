 ...
 * @author Jose Armando
 */
public class ExternoPersonalizadoDAO extends GenericHibernateDAO<ExternoPersonalizado, Integer>
        implements ExternoPersonalizadoDAOIF {
    ...
    public Mensaje getExternoPersonalAll(String uuidCxn) {//JSA01
        List<ExternoPersonalizado> values;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from ExternoPersonalizado");
            values = q.list();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getExternoPersonalAll()1_Error: ").append(ex));
            try {
    ...
    public Mensaje getExternoPersonalPerfilHerr(Perfiles perfil, Herramienta herramienta, String uuidCxn) {//JSA01
        ...
        try {
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getExternoPersonalPerfilHerr()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getExternoPersonalUsuarioHerr(Usuario user, Herramienta herramienta, String uuidCxn) {//JSA01
        ...
        try {
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getExternoPersonalUsuarioHerr()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getExternosPersonalPerfil(Perfiles perfil, String uuidCxn) {//JSA01
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from ExternoPersonalizado o where perfil = :perfil");
            q.setEntity("perfil", perfil);
            values = q.list();
            mensajeResultado.setResultado(values);
            mensajeResultado.setNoError(0);
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getExternosPersonalPerfil()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getExternosPersonalPerfilSinUsuarios(Perfiles perfil, String uuidCxn) {//JSA01,JSA02
        List<ExternoPersonalizado> values;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from ExternoPersonalizado o where perfil = :perfil and usuario  is null ");
            q.setEntity("perfil", perfil);
            values = q.list();
            mensajeResultado.setResultado(values);
            mensajeResultado.setNoError(0);
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getExternosPersonalPerfilSinUsuarios()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getExternosPersonalUsuario(Usuario user, String uuidCxn) {//JSA01
        ...
        try {
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getExternosPersonalUsuario()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje agregar(ExternoPersonalizado entity, String uuidCxn) {//JSA01
        ExternoPersonalizado externoPersonalizado;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            externoPersonalizado = makePersistent(entity);
            mensajeResultado.setResultado(externoPersonalizado);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
