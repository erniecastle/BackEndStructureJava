 ...
 * Software. Descripción del programa: clase Estados para llamados a metodos de
 * HIBERNATE
 * -----------------------------------------------------------------------------
 * MODIFICACIONES:
 * -----------------------------------------------------------------------------
...
public class EstadosDAO extends GenericHibernateDAO<Estados, String>//AAP01
        implements EstadosDAOIF {
    ...
    private List<Estados> listEsp = new ArrayList<Estados>();
    ...
    public Mensaje agregar(Estados entity, String uuidCxn) {
        ...
        try {
            ...
            estados = makePersistent(entity);
            mensajeResultado.setResultado(estados);
    ...
    public Mensaje getEstadosAll(String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Estados order by clave");
            values = q.list();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getEstadosAll()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getEstadosPorClave(String clave, String uuidCxn) {//AAP01
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Estados where clave=:clave");
            q.setParameter("clave", clave);
            e = (Estados) q.uniqueResult();
            mensajeResultado.setResultado(e);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getEstadosPorClave()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getEstadosPorPais(String clavePais, String uuidCxn) {
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Estados where paises.clave = :paises");
            q.setParameter("paises", clavePais);
            listEsp = q.list();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getEstadosPorPais()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje consultaPorFiltrosEstado(String query, Object[] campos, Object[] valores, Integer inicio, Integer rango, String uuidCxn) {
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = (List<Estados>) consultaPorFiltros(query, campos, valores, inicio, rango);
            mensajeResultado.setResultado(listEsp);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("consultaPorFiltrosEstado()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje consultaPorRangos(Integer inicio, Integer rango, String uuidCxn) {
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = (List<Estados>) consultaPorRangos(inicio, rango, null, null);
            mensajeResultado.setResultado(listEsp);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
    ...
    public Mensaje existeDato(String campo, Object valor, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            b = existeDato("Estados", campo, valor);
    ...
    public Mensaje saveDeleteEstados(List<Estados> entitysCambios, Object[] clavesDelete, int rango, String uuidCxn) {
        ...
        try {
            ...
            if (clavesDelete != null) {
                deleteListQuerys("Estados", "Clave", clavesDelete , uuidCxn);
            }
            entitysCambios = (entitysCambios == null ? new ArrayList<Estados>() : entitysCambios);
            if (commit && !entitysCambios.isEmpty()) {
                listEsp = agregarListaEstados(entitysCambios, rango ,  uuidCxn);
            }
            if (commit) {
                mensajeResultado.setResultado(listEsp);
                mensajeResultado.setNoError(0);
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("saveDeleteEstados()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    private List<Estados> agregarListaEstados(List<Estados> entitys, int rango, String uuidCxn) {
        listEsp.clear();
        try {
            int i = 0;
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("agregarListaEstados()1_Error: ").append(ex));
            mensajeResultado.setNoError(ControlErroresHibernate.buscaNoErrorPorExcepcion(ex.getClass()));
            mensajeResultado.setError(ex.getLocalizedMessage());
            mensajeResultado.setResultado(null);
            commit = false;
