 ...
 */
public class EstrucCuentaDAO extends GenericHibernateDAO<EstrucCuenta, Long> implements EstrucCuentaDAOIF {
    ...
    public Mensaje agregar(List<EstrucCuenta> entity, String uuidCxn) {
        EstrucCuenta estruccuenta;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            for (int i = 0; i < entity.size(); i++) {
                estruccuenta = makePersistent(entity.get(i));
                mensajeResultado.setResultado(estruccuenta);
    ...
    public Mensaje getEstrucCuentaAll(String uuidCxn) {
        List<EstrucCuenta> list;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from EstrucCuenta");
            list = q.list();
