/**
 * @author: Victor Fecha de Creación: 01/02/2011 Compañía: Macropro. Descripción
 * del programa: clase ElementosExterno para llamados a metodos de HIBERNATE
 * -----------------------------------------------------------------------------
 * MODIFICACIONES:
 * -----------------------------------------------------------------------------
 ...
 * @author Jose Armando
 */
public class ElementoExternoDAO extends GenericHibernateDAO<ElementoExterno, Integer>
        implements ElementoExternoDAOIF {
    ...
    public Mensaje getElementoExAll(String uuidCxn) {
        ...
        try {
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getElementoExAll()1_Error: ").append(ex));
            try {
    ...
    public Mensaje agregar(ElementoExterno entity, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            elementoExterno = makePersistent(entity);
            mensajeResultado.setResultado(elementoExterno);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
    ...
    public Mensaje getElementoExPorContenedor(Contenedor entity, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from ElementoExterno e where contenedor = :id");
            q.setParameter("id", entity);
            elementoExterno = (ElementoExterno) q.uniqueResult();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getElementoExPorContenedor()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje SaveElementoExterno(List<ElementoExterno> e, String uuidCxn) {
        ...
        try {
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("SaveElementoExterno()1_Error: ").append(ex));
            try {
                if (tx != null) {
                    tx.rollback();
                }
    ...
    public Mensaje DeleteElementoExterno(List<ElementoExterno> e, String uuidCxn) {
        ...
        try {
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("DeleteElementoExterno()1_Error: ").append(ex));
            try {
                if (tx != null) {
                    tx.rollback();
                }
