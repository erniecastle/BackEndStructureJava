 ...
 * Descripción del programa: clase AguinaldoFechas para llamados a metodos de
 * HIBERNATE
 * -----------------------------------------------------------------------------
 */
 ...
 */
public class AguinaldoFechasDAO extends GenericHibernateDAO<AguinaldoFechas, Long>
        implements AguinaldoFechasDAOIF {
    ...
    public Mensaje agregar(AguinaldoFechas entity, String uuidCxn) {
        AguinaldoFechas aguinaldoFechas;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            aguinaldoFechas = makePersistent(entity);
            mensajeResultado.setResultado(aguinaldoFechas);
    ...
    public Mensaje getAguinaldoFechasAll(String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            query = getSession().createQuery("from AguinaldoFechas");
            values = query.list();
    ...
    public Mensaje getAguinaldoFechasPorClave(String claveRazonsocial, String uuidCxn) {
        List<AguinaldoFechas> r;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from AguinaldoFechas d where d.razonesSociales.clave=:claveRazonsocial ");
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getAguinaldoFechasClave()2_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
