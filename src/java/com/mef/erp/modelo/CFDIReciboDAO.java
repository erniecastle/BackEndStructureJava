...
public class CFDIReciboDAO extends GenericHibernateDAO<CFDIRecibo, Long>
        implements CFDIReciboDAOIF {
    ...
    public Mensaje agregar(CFDIRecibo entity, String uuidCxn) {
        CFDIRecibo nominaCfdi;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            nominaCfdi = makePersistent(entity);
            mensajeResultado.setResultado(nominaCfdi);
    ...
    public Mensaje getCFDIReciboAll(String uuidCxn) {
        List<CFDIRecibo> values;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from NominaCFDI");
            values = ((List<CFDIRecibo>) q.list());
            mensajeResultado.setResultado(values);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getNominaCFDIAll()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje consultaPorRangos(Integer inicio, Integer rango, String uuidCxn) {
        List<CFDIRecibo> listEsp;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = ((List<CFDIRecibo>) consultaPorRangos(inicio, rango, null, null));
    ...
    public Mensaje existeDato(String campo, Object valor, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            existe = existeDato(CFDIRecibo.class.getSimpleName(), campo, valor);
    ...
    public Mensaje saveDeleteCFDIRecibo(List<CFDIRecibo> entitysCambios, Object[] clavesDelete, int rango, String uuidCxn) {
        List<CFDIRecibo> listEsp = new ArrayList<CFDIRecibo>();
        try {
            commit = true;
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            ...
            entitysCambios = (entitysCambios == null ? new ArrayList<CFDIRecibo>() : entitysCambios);
            if (commit && !entitysCambios.isEmpty()) {
                listEsp = agregarListaNominaCFDI(entitysCambios, rango);
            }
            if (commit) {
                mensajeResultado.setResultado(listEsp);
                mensajeResultado.setNoError(0);
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("saveDeleteNominaCFDI()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    private List<CFDIRecibo> agregarListaNominaCFDI(List<CFDIRecibo> entitys, int rango) {
        ...
        try {
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("agregarListaNominaCFDI()1_Error: ").append(ex));
            commit = false;
            mensajeResultado.setNoError(ControlErroresHibernate.buscaNoErrorPorExcepcion(ex.getClass()));
            mensajeResultado.setError(ex.getLocalizedMessage());
            mensajeResultado.setResultado(null);
    ...
    private boolean deleteListNominaCFDI(String tabla, String campo, Object[] valores) {
        boolean commitDelete = true;
        try {
            deleteListQuery(tabla, campo, valores);
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("deleteListNominaCFDI()1_Error: ").append(ex));
            mensajeResultado.setNoError(ControlErroresHibernate.buscaNoErrorPorExcepcion(ex.getClass()));
            mensajeResultado.setError(ex.getLocalizedMessage());
            mensajeResultado.setResultado(null);
            commitDelete = false;
