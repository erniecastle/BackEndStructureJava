 ...
 * BaseAfectadaConceptoNominaDAO para llamados a metodos de HIBERNATE
 * -----------------------------------------------------------------------------
 * MODIFICACIONES:
 * -----------------------------------------------------------------------------
 ...
 * @author daniel
 */
public class BaseAfectadaConceptoNominaDAO extends GenericHibernateDAO<BaseAfecConcepNom, Long>
        implements BaseAfectadaConceptoNominaDAOIF {
    ...
    private List<BaseAfecConcepNom> listEsp = new ArrayList<BaseAfecConcepNom>();

    public Mensaje agregar(BaseAfecConcepNom entity, String uuidCxn) {//JSA01
        BaseAfecConcepNom baseAfectadaConceptoNomina;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            baseAfectadaConceptoNomina = makePersistent(entity);
            mensajeResultado.setResultado(baseAfectadaConceptoNomina);
    ...
    public Mensaje getBaseAfectadaConceptoNominaAll(String uuidCxn) {//JSA01
        List<BaseAfecConcepNom> values;
        try {
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from BaseAfectadaConceptoNomina");
            values = q.list();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getBaseAfectadaConceptoNominaAll()1_Error: ").append(ex));
            getSession().getTransaction().rollback();
        }
        return mensajeResultado;
    }
    ...
    public Mensaje getBaseAfectadaConceptoNominaPorClave(String clave, String uuidCxn) {//JSA01
        ...
        try {
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from BaseAfectadaConceptoNomina where clave=:clave");
            q.setParameter("clave", clave);
            r = (BaseAfecConcepNom) q.uniqueResult();
            mensajeResultado.setResultado(r);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getBaseAfectadaConceptoNominaPorClave()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje consultaPorRangos(Integer inicio, Integer rango, String uuidCxn) {//JSA01
        try {
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = (List<BaseAfecConcepNom>) consultaPorRangos(inicio, rango, null, null);
    ...
    public Mensaje agregarListaBaseAfectadaConceptoNomina(List<BaseAfecConcepNom> entitys, int rango, String uuidCxn) {//JSA01
        ...
        try {
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("agregarListaBaseAfectadaConceptoNomina()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
