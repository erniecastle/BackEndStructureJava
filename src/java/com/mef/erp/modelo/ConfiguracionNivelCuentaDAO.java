 ...
 */
public class ConfiguracionNivelCuentaDAO extends GenericHibernateDAO<ConfiguracionNivelCuenta, Long> implements ConfiguracionNivelCuentaDAOIF {
    ...
    public Mensaje agregar(ConfiguracionNivelCuenta entity, String uuidCxn) {
        ConfiguracionNivelCuenta configuracionnivelcuenta;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            configuracionnivelcuenta = makePersistent(entity);
            mensajeResultado.setResultado(configuracionnivelcuenta);
    ...
    public Mensaje saveDeleteConfiguracionNivelCuenta(ConfiguracionNivelCuenta entity, List<Long> eliminados, String uuidCxn) {
        ...
        try {
            ...
            if (eliminados != null && !eliminados.isEmpty()) {
                deleteListQuery(EstrucCuenta.class.getSimpleName(), "id", eliminados.toArray());
            }
            configuracionnivelcuenta = makePersistent(entity);
            mensajeResultado.setResultado(configuracionnivelcuenta);
            mensajeResultado.setNoError(0);
    ...
    public Mensaje getConfiguracionNivelCuentaUnico(String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from ConfiguracionNivelCuenta");
            configuracionnivelcuenta = (ConfiguracionNivelCuenta) q.uniqueResult();
            mensajeResultado.setResultado(configuracionnivelcuenta);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
