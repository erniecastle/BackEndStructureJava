 ...
 * SalariosIntegradosDAO para llamados a metodos de HIBERNATE Fecha:02-07-2012
 * -----------------------------------------------------------------------------
 * MODIFICACIONES:
 * -----------------------------------------------------------------------------
 ...
 * @author daniel
 */
public class SalariosIntegradosDAO extends GenericHibernateDAO<SalariosIntegrados, Long>
        implements SalariosIntegradosDAOIF {
    ...
    private List<SalariosIntegrados> listEsp = new ArrayList<SalariosIntegrados>();
    ...
    public Mensaje agregar(SalariosIntegrados entity, String uuidCxn) {
        ...
        try {
            ...
            salariosIntegrados = makePersistent(entity);
            mensajeResultado.setResultado(salariosIntegrados);
    ...
    public Mensaje getSalariosIntegradosAll(RazonesSociales razonesSociales, String uuidCxn) {
        List<SalariosIntegrados> values;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("select s from SalariosIntegrados s inner join s.empleados emp where emp.razonesSociales.clave = :razonesSociales order by id");
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getSalariosIntegradosAll()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getSalariosIntegradosPorEmpleadoyRegPat(Empleados empleados, RegistroPatronal registroPatronal, Date fecha, String uuidCxn) {
        SalariosIntegrados r;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from SalariosIntegrados where empleados=:empleados and registroPatronal = :registroPatronal and fecha = :fecha");
            q.setParameter("empleados", empleados);
            q.setParameter("fecha", fecha);
            q.setParameter("empleados", empleados);
            r = (SalariosIntegrados) q.uniqueResult();
            mensajeResultado.setResultado(r);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getSalariosIntegradosPorEmpleadoyRegPat()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getSDIActualPorEmpleadoyRegPatActual(String claveEmpleados, String claveRegistroPatronal, Date fecha, RazonesSociales razonesSociales, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("select SDI from SalariosIntegrados SDI inner join SDI.empleados emp where emp.razonesSociales.clave = :razonesSociales and emp.clave=:claveEmpleados and SDI.registroPatronal.clave = :claveRegistroPatronal and SDI.fecha <= :fecha order by SDI.fecha desc");
            q.setParameter("claveEmpleados", claveEmpleados);
            q.setParameter("claveRegistroPatronal", claveRegistroPatronal);
            q.setParameter("fecha", fecha);
            q.setParameter("razonesSociales", razonesSociales.getClave());
            q.setMaxResults(1);
            r = (SalariosIntegrados) q.uniqueResult();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getSDIActualPorEmpleadoyRegPatActual()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getSalariosIntegradosPorRegPatronal(RegistroPatronal registroPatronal, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("Select si from SalariosIntegrados si Where si.registroPatronal = :registroPatronal");
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getSalariosIntegradosPorRegPatronal()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje consultaPorRangos(Integer inicio, Integer rango, String uuidCxn) {
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = (List<SalariosIntegrados>) consultaPorRangos(inicio, rango, null, null);
    ...
    public Mensaje consultaPorFiltrosSalario(String query, Object[] campos, Object[] valores, String uuidCxn) {
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = (List<SalariosIntegrados>) consultaPorFiltros(query, campos, valores, null, null);
            mensajeResultado.setResultado(listEsp);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
    ...
    public Mensaje existeDato(String campo, Object valor, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            existe = existeDato("SalariosIntegrados", campo, valor);
