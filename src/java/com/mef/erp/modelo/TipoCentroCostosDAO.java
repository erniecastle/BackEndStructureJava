...
public class TipoCentroCostosDAO extends GenericHibernateDAO<TipoCentroCostos, Long>
        implements TipoCentroCostosDAOIF {
    ...
    private List<TipoCentroCostos> listEsp = new ArrayList<TipoCentroCostos>();
    private Boolean commit = false;

    public Mensaje agregar(TipoCentroCostos entity, String uuidCxn) {
        TipoCentroCostos tipoCentroCostos;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            tipoCentroCostos = makePersistent(entity);
            mensajeResultado.setResultado(tipoCentroCostos);
    ...
    public Mensaje getTipoCentroCostosAll(String claveRazonesSocial, String uuidCxn) {
        List<TipoCentroCostos> values;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from TipoCentroCostos c where c.razonesSociales.clave=:clave");
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getTipoCentroCostosAll()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getTipoCentroCostosPorClave(String clave, String claveRazonesSocial, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from TipoCentroCostos c where c.clave=:clave and c.razonesSociales.clave=:claveRazonSocial");
            q.setParameter("clave", clave);
            q.setParameter("claveRazonSocial", claveRazonesSocial);
            n = (TipoCentroCostos) q.uniqueResult();
            mensajeResultado.setResultado(n);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getTipoCentroCostosPorClave()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje consultaPorFiltrosTipoCentroCostos(String query, Object[] campos, Object[] valores, Integer inicio, Integer rango, String uuidCxn) {
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = (List<TipoCentroCostos>) consultaPorFiltros(query, campos, valores, inicio, rango);
    ...
    public Mensaje consultaPorRangosTipoCentroCostos(Integer inicio, Integer rango, String[] camposWhere, Object[] camposWhereValores, String uuidCxn) {
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = (List<TipoCentroCostos>) consultaPorRangos(inicio, rango, camposWhere, camposWhereValores);
            mensajeResultado.setResultado(listEsp);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
    ...
    public Mensaje existeDato(String campo, Object valor, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            existe = existeDato("TipoCentroCostos", campo, valor);
    ...
    public Mensaje saveDeleteTipoCentroCostos(List<TipoCentroCostos> entitysCambios, Object[] clavesDelete, int rango, String uuidCxn) {
        listEsp = new ArrayList<TipoCentroCostos>();
        try {
            commit = true;
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            ...
            if (clavesDelete != null) {
                commit = deleteListQuerys("TipoCentroCostos", "Clave", clavesDelete);
                clear();
            }
            entitysCambios = (entitysCambios == null ? new ArrayList<TipoCentroCostos>() : entitysCambios);
            if (commit && !entitysCambios.isEmpty()) {
                listEsp = agregarListaTipoCentroCostos(entitysCambios, rango);
                if (commit) {
                    flush();
                }
            }
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("saveDeleteTipoCentroCostos()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    private List<TipoCentroCostos> agregarListaTipoCentroCostos(List<TipoCentroCostos> entitys, int rango) {
        listEsp.clear();
        commit = true;
        try {
            int i;
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("agregarListaTipoCentroCostos()1_Error: ").append(ex));
            mensajeResultado.setNoError(ControlErroresHibernate.buscaNoErrorPorExcepcion(ex.getClass()));
            mensajeResultado.setError(ex.getLocalizedMessage());
            mensajeResultado.setResultado(null);
            commit = false;
