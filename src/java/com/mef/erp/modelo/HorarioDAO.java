/**
 * @author: Victor Lopez Fecha de Creación: 30/08/2011 Compañía: MacroPro
 * Descripción del programa: clase Horario para llamados a metodos de HIBERNATE
 * -----------------------------------------------------------------------------
 * MODIFICACIONES:
 * -----------------------------------------------------------------------------
...
public class HorarioDAO extends GenericHibernateDAO<Horario, Long> implements HorarioDAOIF {
    ...
    private List<Horario> listEsp = new ArrayList<Horario>();
    ...
    public Mensaje agregar(Horario entity , String uuidCxn) {//JSA01
        ...
        try {
            ...
            horario = makePersistent(entity);
            mensajeResultado.setResultado(horario);
    ...
    public Mensaje getHorarioAll(String uuidCxn) {//JSA01
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Horario");
            values = q.list();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getHorarioAll()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getHorarioPorClave(String clave , String uuidCxn) {//AAP01//JSA01
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Horario where clave=:clave");
            q.setParameter("clave", clave);
            p = (Horario) q.uniqueResult();
            mensajeResultado.setResultado(p);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getHorarioPorClave()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje consultaPorFiltrosHorario(String query, Object[] campos, Object[] valores , String uuidCxn) {//JSA01
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = (List<Horario>) consultaPorFiltros(query, campos, valores, null, null);
    ...
    public Mensaje consultaPorRangos(Integer inicio, Integer rango , String uuidCxn) {//JSA01
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = (List<Horario>) consultaPorRangos(inicio, rango, null, null);
            mensajeResultado.setResultado(listEsp);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
    ...
    public Mensaje existeDato(String campo, Object valor , String uuidCxn) {//JSA01
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            existe = existeDato("Horario", campo, valor);
    ...
    public Mensaje getHorariosPorRazonSocial(RazonesSociales razonSocial , String uuidCxn) {//JSA01
        List<Horario> values = null;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Horario where razonSocial=:razonSocial");
            q.setParameter("razonSocial", razonSocial);
            values = (List<Horario>) q.uniqueResult();
            mensajeResultado.setResultado(values);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getHorariosPorRazonSocial()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
