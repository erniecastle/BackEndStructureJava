 ...
 * @author daniel
 */
public class DocumentacionDAO extends GenericHibernateDAO<Documentacion, Long>
        implements DocumentacionDAOIF {
    ...
    public Mensaje agregar(Documentacion entity, String uuidCxn) {
        ...
        try {
            ...
            doc = makePersistent(entity);
            mensajeResultado.setResultado(doc);
    ...
    public Mensaje getDocumentacionAll(String uuidCxn) {
        List<Documentacion> values;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Documentacion");
            values = q.list();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getDocumentacionAll()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getDocumentacionPorId(Long id, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Documentacion where id=:id");
            q.setParameter("id", id);
            doc = (Documentacion) q.uniqueResult();
            mensajeResultado.setResultado(doc);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getDocumentacionPorId()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getDocumentacionPorEmpleados(Empleados e, String uuidCxn) {//JSA01
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Documentacion where empleados = :empleado");
            q.setEntity("empleado", e);
            documentacion = q.list();
            mensajeResultado.setResultado(documentacion);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getDocumentacionPorEmpleados()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getDocumentacionPorIDEmpleado(Long clave, String uuidCxn) {//JSA01
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Documentacion where empleados_id=:clave");
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getDocumentacionPorIDEmpleado()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje EliminaDocumentacionPorEmpleado(Empleados empleado, String uuidCxn) {//JSA01
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("delete from Documentacion where empleados = :empleado");
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("EliminaDocumentacionPorEmpleado()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
