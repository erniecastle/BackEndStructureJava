 ...
 * BaseAfectadaGrupoDAO para llamados a metodos de HIBERNATE
 * -----------------------------------------------------------------------------
 * MODIFICACIONES:
 * -----------------------------------------------------------------------------
 ...
 * @author daniel
 */
public class BaseAfectadaGrupoDAO extends GenericHibernateDAO<BaseAfectadaGrupo, Long>
        implements BaseAfectadaGrupoDAOIF {
    ...
    private List<BaseAfectadaGrupo> listEsp = new ArrayList<BaseAfectadaGrupo>();

    public Mensaje agregar(BaseAfectadaGrupo entity, String uuidCxn) {//JSA01
        BaseAfectadaGrupo baseAfectadaGrupo;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            baseAfectadaGrupo = makePersistent(entity);
            mensajeResultado.setResultado(baseAfectadaGrupo);
    ...
    public Mensaje getBaseAfectadaGrupoAll(String uuidCxn) {//JSA01
        List<BaseAfectadaGrupo> values;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from BaseAfectadaGrupo");
            values = q.list();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getBaseAfectadaGrupoAll()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getBaseAfectadaGrupoPorClave(String clave, String uuidCxn) {//JSA01
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from BaseAfectadaGrupo where clave=:clave");
            q.setParameter("clave", clave);
            r = (BaseAfectadaGrupo) q.uniqueResult();
            mensajeResultado.setResultado(r);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getBaseAfectadaGrupoPorClave()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje consultaPorRangos(Integer inicio, Integer rango, String uuidCxn) {//JSA01
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = (List<BaseAfectadaGrupo>) consultaPorRangos(inicio, rango, null, null);
    ...
    public Mensaje agregarListaBaseAfectadaGrupo(List<BaseAfectadaGrupo> entitys, int rango, String uuidCxn) {//JSA01
        ...
        try {
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("agregarListaBaseAfectadaGrupo()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
