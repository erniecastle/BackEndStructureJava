...
public class PrimasDAO extends GenericHibernateDAO<Primas, Long>
        implements PrimasIF {
    ...
    public Mensaje agregar(Primas entity, String uuidCxn) {//JSA02
        ...
        try {
            ...
            primas = makePersistent(entity);
            mensajeResultado.setResultado(primas);
    ...
    public Mensaje getPrimasAll(String uuidCxn) {//JSA02
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Primas");
            values = q.list();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getPrimasAll()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getPrimasPorClaveRegistroPatronal(Long clave, String uuidCxn) {//JSA02
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Primas where registrospatronal_id=:clave");
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getPrimasPorClaveRegistroPatronal()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje DeletePrimasByRegistroPatronal(Long registroPatronal, String uuidCxn) {//JSA02
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("delete from Primas where registrospatronal_id=:registroPatronal");
            q.setLong("registroPatronal", registroPatronal);
            q.executeUpdate();
            mensajeResultado.setResultado(true);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("DeletePrimasByRegistroPatronal()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje SavePrimas(List<Primas> agrega, List<Primas> elimina, RegistroPatronal r, String uuidCxn) {//JSA02
        try {
            ...
            for (Primas d : elimina) {
                makeTransient(d);
            }
            for (int i = 0; i < agrega.size(); i++) {
                agrega.get(i).setRegistrospatronal(r);
                makePersistent(agrega.get(i));
                if (i % 100 == 0) {
                    flush();
                }
            }
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("SavePrimas()1_Error: ").append(e));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje DeletePrimas(List<Primas> p, String uuidCxn) {//JSA02
        try {
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("DeletePrimas()1_Error: ").append(e));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje deleteListClavesPrimas(Object[] valores, String uuidCxn) {//JSA02
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            deleteListQuery(Primas.class.getSimpleName(), "id", valores);
            mensajeResultado.setResultado(true);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("deleteListClavesPrimas()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
