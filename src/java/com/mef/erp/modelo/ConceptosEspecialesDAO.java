...
public class ConceptosEspecialesDAO extends GenericHibernateDAO<ConceptosEspeciales, String>//AAP01
        implements ConceptosEspecialesDAOIF {
    ...
    public Mensaje agregar(ConceptosEspeciales entity, String uuidCxn) {
        ConceptosEspeciales conceptosEspeciales;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            conceptosEspeciales = makePersistent(entity);
            mensajeResultado.setResultado(conceptosEspeciales);
    ...
    public Mensaje getConceptosEspecialesPorTipo(TipoConceptosEspeciales claveTipo, String uuidCxn) {
        List<ConceptosEspeciales> p;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            query = getSession().createQuery("from ConceptosEspeciales where tipoConceptosEspeciales = :claveTipo");
            query.setParameter("claveTipo", claveTipo.ordinal(), Hibernate.INTEGER);//JEVC01
            p = query.list();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getConceptosEspecialesPorTipo()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getExisteConceptosEspecialesPorTipoYconcepto(String claveConceptoDeNomina, TipoConceptosEspeciales claveTipo, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            query = getSession().createQuery("select count(o) from ConceptosEspeciales o where o.conceptoDeNomina.clave = :claveConceptoDeNomina and o.tipoConceptosEspeciales !=:claveTipo");
            query.setParameter("claveTipo", claveTipo.ordinal(), Hibernate.INTEGER);
            query.setParameter("claveConceptoDeNomina", claveConceptoDeNomina);
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getExisteConceptosEspecialesPorTipoYconcepto()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje saveDeleteConceptosEspeciales(List<ConceptosEspeciales> AgreModif, Object[] clavesDelete, String uuidCxn) {
        try {
            ...
            for (ConceptosEspeciales Ce : AgreModif) {
                makePersistent(Ce);
            }
            mensajeResultado.setResultado(true);
            mensajeResultado.setNoError(0);
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("saveDeleteConceptosEspeciales()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getConceptosNominaClavesPorTipo(TipoConceptosEspeciales claveTipo, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            query = getSession().createQuery("select c.conceptoDeNomina.clave from ConceptosEspeciales c where tipoConceptosEspeciales = :claveTipo");
            query.setParameter("claveTipo", claveTipo);
            p = query.list();
            mensajeResultado.setResultado(p);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getConceptosNominaClavesPorTipo()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getConceptosEspecialesAll(String uuidCxn) {
        List<ConceptosEspeciales> list;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            query = getSession().createQuery("from ConceptosEspeciales");
            list = query.list();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getConceptosEspecialesAll()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
