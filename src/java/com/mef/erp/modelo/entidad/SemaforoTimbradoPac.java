...
@Entity
@Table(name = "SemaforoTimbradoPac",
        uniqueConstraints = {
            @UniqueConstraint(columnNames = {"tipoNomina_ID", "periodoNomina_ID"})})
public class SemaforoTimbradoPac implements Serializable {
    ...
    public enum Tipo {
        ABRIENDO_PERIODO, GENERANDO_DATOS_TIMBRADO, TIMBRANDO,CANCELANDO_TIMBRADOS;
    }
}
