/**
 * @author: Ernesto Fecha de Creación: 06/06/2011 Compañía: ExitoSoftware
 * Descripción del programa: clase Municipios para llamados a metodos de
 * HIBERNATE
 * -----------------------------------------------------------------------------
 * MODIFICACIONES:
 * -----------------------------------------------------------------------------
...
public class MunicipiosDAO extends GenericHibernateDAO<Municipios, String>//AAP01
        implements MunicipiosDAOIF {
    ...
    private List<Municipios> listEsp = new ArrayList<Municipios>();
    private Boolean commit = false;

    public Mensaje getMunicipiosAll(String uuidCxn) {
        List<Municipios> values;
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Municipios");
            values = q.list();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getMunicipiosAll()1_Error: ").append(ex));
            try {
    ...
    public Mensaje agregar(Municipios entity, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            municipios = makePersistent(entity);
            mensajeResultado.setResultado(municipios);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
    ...
    public Mensaje getMunicipiosPorClave(String clave, String uuidCxn) {//AAP01
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Municipios where clave=:clave");
            q.setParameter("clave", clave);
            e = (Municipios) q.uniqueResult();
            mensajeResultado.setResultado(e);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
        } catch (HibernateException ex) {
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getMunicipiosPorClave()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getMunicipiosPorEstado(String claveEstado, String uuidCxn) {
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Municipios where estados.clave =:edos");
            q.setParameter("edos", claveEstado);
            listEsp = q.list();
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getMunicipioPorEstado()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje getMunicipiosPorPais(String clavePais, String uuidCxn) {
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            q = getSession().createQuery("from Municipios where estados.paises.clave =:pais");
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("getMunicipiosPorPais()1_Error: ").append(ex));
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
                }
    ...
    public Mensaje consultaPorFiltrosMunicipio(String query, Object[] campos, Object[] valores, Integer inicio, Integer rango, String uuidCxn) {
        try {
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = (List<Municipios>) consultaPorFiltros(query, campos, valores, inicio, rango);
            mensajeResultado.setResultado(listEsp);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
    ...
    public Mensaje consultaPorRangos(Integer inicio, Integer rango, String uuidCxn) {
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            listEsp = (List<Municipios>) consultaPorRangos(inicio, rango, null, null);
            mensajeResultado.setResultado(listEsp);
            mensajeResultado.setNoError(0);
            mensajeResultado.setError("");
            getSession().getTransaction().commit();
    ...
    public Mensaje existeDato(String campo, Object valor, String uuidCxn) {
        ...
        try {
            ...
            setSession(HibernateUtil.currentSession(uuidCxn));
            getSession().beginTransaction();
            b = existeDato("Municipios", campo, valor);
    ...
    public Mensaje saveDeleteMunicipios(List<Municipios> entitysCambios, Object[] clavesDelete, int rango, String uuidCxn) {
        listEsp = new ArrayList<Municipios>();
        try {
            commit = true;
            inicializaVariableMensaje();
            setSession(HibernateUtil.currentSession(uuidCxn));
            ...
            entitysCambios = (entitysCambios == null ? new ArrayList<Municipios>() : entitysCambios);
            if (commit && !entitysCambios.isEmpty()) {
                listEsp = agregarListaMunicipios(entitysCambios, rango);
            }
            if (commit) {
                mensajeResultado.setResultado(listEsp);
                mensajeResultado.setNoError(0);
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("saveDeleteMunicipios()1_Error: ").append(ex));
            listEsp = null;
            try {
                if (getSession().getTransaction().isActive()) {
                    getSession().getTransaction().rollback();
    ...
    private List<Municipios> agregarListaMunicipios(List<Municipios> entitys, int rango) {
        ...
        try {
            ...
            System.err.println(concatena.delete(0, concatena.length()).append(msgError).append("agregarListaMunicipios()1_Error: ").append(ex));
            mensajeResultado.setNoError(ControlErroresHibernate.buscaNoErrorPorExcepcion(ex.getClass()));
            mensajeResultado.setError(ex.getLocalizedMessage());
            mensajeResultado.setResultado(null);
            commit = false;
